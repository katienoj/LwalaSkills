  ...
  <tr>
    <td colspan="8">
      <table width="100%" border="0" class="bordercolor2" style="background-image:url(../Main/Layout/images/form_top.jpg); background-repeat:repeat-x;">
        <td width="94%" class="formtop" onMouseDown="javascript:getReadyToMove('popup_div', event);"> Charge Sheet for <?php echo $PatientName; ?> </td>
...
<tr>
  <td  colspan="2">Charge Procedure</td>
  <td ></td>
...
<table width="100%" class="table" bgcolor="#FFFFFF">
  <tr>
    ...
    <td > <a href="#" onclick="addDoctorInvoice()"> Add Doctor Invoice</a></td>
    <td  style="color:#0000FF"> </td>
  </tr>
</table>
