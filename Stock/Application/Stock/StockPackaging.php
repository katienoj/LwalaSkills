...
<table width="620" border="0" bgcolor="#E4E4E4" class="formborder">
  <tr>
    <td>
      <table width="100%" border="0" class="bordercolor2" style="background-image:url(../Main/Layout/images/form_top.jpg); background-repeat:repeat-x;">
        <tr>
          <td width="94%" class="formtop" onMouseDown="javascript:getReadyToMove('popup_div_1', event);" onMouseUp="javascript:dropLoadedObject(event)" onClick="javascript:dropLoadedObject(event);"><?php echo StockName($StockId); ?>'s Packaging Details</td>
  ...
  <tr>
    <td><a href="#" onclick="DeletePackaging()">Delete Packaging</a> </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <table width="100%" border="0">
        <tr>
          ...
          <td><?php
              $packagelist = "<select id='Packaging' name='Packaging' id='Packaging' class='form-control'>";
          ...
          <td><input class="form-control" name="PackageQty" type="text" id="PackageQty" onblur="number_string(getElementById('PackageQty'),'Invalid Qty figure typed in')"></td>
        </tr>
        <tr>
          <td>
            <div align="right">Packaging Type </div>
          </td>
          <td><?php
              $packagelist = "<select id='PackagingType' name='PackagingType' class=form-control>";
              $packagelist .= "<option class='form-control' value=''>--Please select--</option>";
          ...
          <td><input class="form-control" name="PackagingId" type="hidden" class="alertsBox" id="PackagingId">
            ...
            <input class="form-control" name="PackagePrice" type="hidden" class="alertsBox" id="PackagePrice" />
            <input class="form-control" name="PackageBarcode" type="hidden" class="alertsBox" id="PackageBarcode" />
          </td>
        </tr>
        <tr>
