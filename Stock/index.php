...
<script language="javascript" type="text/javascript" src="Layout/js_scripts/Suppliers.js"></script>
<script language="javascript" type="text/javascript" src="Layout/js_scripts/Stock.js"></script>
<script language="javascript" type="text/javascript" src="Layout/js_scripts/Requisitions.js"></script>
<script language="javascript" type="text/javascript" src="Layout/js_scripts/StockValidation.js"></script>
<script language="javascript" type="text/javascript" src="Layout/js_scripts/SupplierCategories.js"></script>
...
<body class="hold-transition sidebar-mini layout-fixed" onLoad="StartModule('<?php echo $ModuleId; ?>');StockDashBoard();" onmousemove="javascript:checkLoadedObjects(event);" onclick="javascript:dropLoadedObject(event);">
<div class="wrapper">
     ...
     <!-- START SIDE BAR -->
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="../admindashboard/index3.html" class="brand-link">
          ...
          <span class="brand-text font-weight-light">Pharmacy Inventory</span>
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
...
<input type="hidden" name="ConfirmVars" id="ConfirmVars" />
<input type="hidden" name="ShowPackageType" id="ShowPackageType" />
