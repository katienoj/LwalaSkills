...
$sqlTempPRQs=mysqli_query($conn, "SELECT * FROM PRQTemp") or die(mysqli_error($conn));
...
$sqlCheckIfExists=mysqli_query($conn, "SELECT * FROM ProcurementRequest") or die(mysqli_error($conn));
