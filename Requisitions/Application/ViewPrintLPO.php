...
$pageName='Application/Requisitions/PrintLPO.php?SelectedLPO='.$SelectedLPO;
...
<iframe name="print_doc" id="print_doc" src="<?php echo $pageName; ?>" scrolling="auto" frameborder="0" style="width:600px; height:720px; display:block; background-color:#FAFAFA;"> </iframe>