...
<script language="javascript" type="text/javascript" src="Layout/js_scripts/StockLPOs.js"></script>
<script language="javascript" type="text/javascript" src="Layout/js_scripts/Procurements.js"></script>
<link rel="stylesheet" href="../DataTables/Bootstrap-4-4.1.1/css/bootstrap.min.css">
    ...
    <script src="../DataTables/Bootstrap-4-4.1.1/js/bootstrap.min.js"></script>
        ...
        <!--<script language="javascript" type="text/javascript" src="../DataTable/sum().js"></script>End--> 
...
<body class="hold-transition sidebar-mini layout-fixed" onLoad="StartModule('<?php echo $ModuleId; ?>'); ProcurementsDashBoard();">
<div class="wrapper">
